-- Blog Submissions and Blog Posts Tables
-- Run this in your Supabase SQL Editor

-- Blog submissions table (stores submitted blog posts awaiting review)
...
-- Blog posts table (stores published blog posts)
...
-- Allow public insert on blog submissions
CREATE POLICY "Allow public insert on blog submissions" ON blog_submissions 
  FOR INSERT WITH CHECK (true);

-- Allow admins to manage blog submissions and posts
-- (Admin policies should be added separately based on your admin authentication)
